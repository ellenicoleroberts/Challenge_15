    ...
    if age is not None:
        ...
        if age <= 0 or age > 65:
            return build_validation_result(
                False,
                "age",
                "Your age should be between 0 and 65 years old, please provide a different age.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investment_amount",
                "The amount you wish to invest should be a minimum of $5000, please provide a correct amount to invest.",
            )
...
def recommend_portfolio(intent_request):
    ...
    # Determines appropriate portfolio given risk level 
    if risk_level == "None":
